...
func AddReadAudience(ctx Context, workflowID, org string, principals []GatePrincipal) error {
	if ctx == nil {
...
func (c *dbosContext) AddReadAudience(_ Context, workflowID, org string, principals []GatePrincipal) error {
	if workflowID == "" {
...
func ReadAllowed(ctx Context, workflowID, org, subject string, groups []string) (bool, error) {
	if ctx == nil {
...
func (c *dbosContext) ReadAllowed(_ Context, workflowID, org, subject string, groups []string) (bool, error) {
...
func ListOpenGatesFor(ctx Context, org, subject string, groups []string, limit int) ([]OpenGateRow, error) {
	if ctx == nil {
...
func (c *dbosContext) ListOpenGatesFor(_ Context, org, subject string, groups []string, limit int) ([]OpenGateRow, error) {
...
func ListDeliveriesBy(ctx Context, org, subject string, limit int) ([]DeliveryRow, error) {
	if ctx == nil {
		return nil, errors.New("ctx cannot be nil")
	}
...
func (c *dbosContext) ListDeliveriesBy(_ Context, org, subject string, limit int) ([]DeliveryRow, error) {
...
func ListDeliveriesFor(ctx Context, workflowID string, limit int) ([]DeliveryRow, error) {
	if ctx == nil {
		return nil, errors.New("ctx cannot be nil")
	}
...
func (c *dbosContext) ListDeliveriesFor(_ Context, workflowID string, limit int) ([]DeliveryRow, error) {
	return sysdb.RetryWithResult(c, func() ([]DeliveryRow, error) {
...
func ListInitiatedBy(ctx Context, org, subject string, limit int) ([]string, error) {
	if ctx == nil {
		return nil, errors.New("ctx cannot be nil")
	}
...
func (c *dbosContext) ListInitiatedBy(_ Context, org, subject string, limit int) ([]string, error) {
